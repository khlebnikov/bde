...
// 'bsl::bad_function_call' is a typedef to the standard's exception type.
// If 'std::bad_function_call' exception isn't available, we need to check
// that 'bsl::bad_function_call' satisfies the interface and contract of
...
//  bool veryVeryVeryVerbose = argc > 5;
    ...
    switch (test) { case 0:
      ...
      case 4: {
        ...
        ASSERT((bsl::is_same<bsl::bad_function_call,
      ...
      case 2: {
        ...
        // N4835: 20.6.5 Class 'bad_function_call' [optional.bad.access]
        //..
        //     namespace std {
